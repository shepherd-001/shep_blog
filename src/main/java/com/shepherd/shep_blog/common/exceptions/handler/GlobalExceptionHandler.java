...
import com.shepherd.shep_blog.common.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleMethodNotAllowed(Exception ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED).body(ErrorResponse.of(ex.getMessage(), ErrorCode.SHEP_BLOG_ERROR, request.getRequestURI()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleEnumConversionError(MethodArgumentTypeMismatchException ex, HttpServletRequest request) {
        ...
        return ResponseEntity.badRequest().body(ErrorResponse.of(message, ErrorCode.SHEP_BLOG_ERROR, request.getRequestURI()));
    }
